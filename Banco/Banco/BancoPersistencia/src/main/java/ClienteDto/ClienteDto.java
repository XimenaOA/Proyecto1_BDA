...
public class ClienteDto {
    ...
    int id;
    String nombre, apellidoPaterno, apellidoMaterno, fehcadenacimiento;
    ...
    public ClienteDto(int id, String nombre, String apellidoPaterno, String apellidoMaterno, String fehcadenacimiento) {
        this.id = id;
        this.nombre = nombre;
