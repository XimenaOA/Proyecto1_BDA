...
public class RetiroDTO {
     ...
     */
    public RetiroDTO(String tipo, long numCuenta, double monto, LocalDateTime fecha, int idCuenta) {
        this.tipo = tipo;
        this.monto = monto;
    ...
    /**
     * Constructor con contraseña y folio
     *
     * @param folio
     * @param contrasena La contraseña necesaria para realizar el retiro.
     */
    public RetiroDTO(long folio,long contrasena) {
     ...
     * @param idCuenta El ID de la cuenta asociada al retiro.
     */
    public RetiroDTO(long folio, long numCuenta, String estado, long contrasena, double monto, LocalDateTime fecha, int idCuenta) {
        this.folio = folio;
        this.estado = estado;
        this.contrasena = contrasena;
        this.numCuenta = numCuenta;
     ...
     * @param idCuenta El ID de la cuenta asociada al retiro.
     */
    public RetiroDTO(String tipo, long numCuenta, long folio, String estado, long contrasena, double monto, LocalDateTime fecha, int idCuenta) {
        this.tipo = tipo;
        this.folio = folio;
        this.estado = estado;
        this.contrasena = contrasena;
